...
Solution: Connect ```nc 2019shell1.picoctf.com 32203```
...
The name is a hint, researching it you see that la cifra de give you ```The cipher now known as the Vigenère cipher, however, is that originally described by Giovan Battista Bellaso in his 1553 book La cifra del Sig. Giovan Battista Bellaso.``` from wikipedia. The cipher is a Vigenère cipher and you can brute force the key or use the key: flag.
