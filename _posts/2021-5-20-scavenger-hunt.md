...
Solution: Check the source code for the flag parts.
...
Answer is http://mercury.picoctf.net:5080/robots.txt
...
Check http://mercury.picoctf.net:5080/.htaccess
...
Check http://mercury.picoctf.net:5080/.DS_Store

```
Congrats! You completed the scavenger hunt. Part 5: _35844447}
```

Then assemble the flag.
